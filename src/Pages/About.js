...
import usict from "../Assets/usict.png";
      ...
      <div className="bg-white dark:bg-dark">
        ...
        <div className="container mx-auto px-4 md:px-2 lg:px-4 mt-10">
          <p className="text-lg dark:text-white">
            ...
            various projects in the past. The tech stack that I mostly used are
            React Native, AWS, Firebase, Java, SQL, etc. I have contributed to
            various open-source projects and also mentored at Girlscript Summer
            of Code 2022, where I have assisted the Project admin and various
        ...
        <section className="container mx-auto px-4 md:px-2 lg:px-4 max-h-max mt-10">
          <div className="flex flex-wrap justify-between">
            ...
            <div className="flex flex-col w-20 text-center transform transition duration-500 hover:scale-125">
              ...
              <h4 className="text-1xl dark:text-white">MySQL</h4>
            </div>
            <div className="flex flex-col w-20 text-center transform transition duration-500 hover:scale-125">
              <svg viewBox="0 0 128 128">
                <path
          ...
          <div className="flex flex-col md:flex-row sm:gap-8 items-center gap-8 px-10 justify-between">
            ...
            <div className="w-full sm:w-fit md:w-9/12 text-left drop-shadow-md dark:drop-shadow-xl bg-white dark:bg-gray-200 p-4 rounded-xl">
              <div className="flex flex-row">
                ...
                <p className="text-sm font-bold absolute right-5 sm:top-9 md:top-5">
                  2023-2025
                </p>
              </div>
              <h2 className="md:text-2xl lg:text-2xl mt-2">
                Masters of Computer Applications (Software Engineering)
              </h2>
              <div className="mt-2">
                <ul className="list-none">
                  <li>
                    ⚡Learning subjects like DSA, OOPs, Computer networking,
                    DBMS, etc.
                  </li>
                </ul>
              </div>
        ...
        <section className="container mx-auto sm:px-2 md:px-2 mt-10">
          <div className="flex flex-col md:flex-row sm:gap-8 items-center gap-8 px-10 justify-between">
            <div className="w-48 h-48 p-4 drop-shadow-md dark:drop-shadow-xl rounded-full bg-white dark:bg-gray-100">
            ...
            <div className="w-full sm:w-fit md:w-9/12 text-left drop-shadow-md dark:drop-shadow-xl bg-white dark:bg-gray-200 p-4 rounded-xl">
              ...
              <div className="mt-2">
                <ul className="list-none">
                  <li>
                    ⚡Scored <span className="font-bold">9.33</span> GPA overall
                    in my degree.
                  </li>
                  <li>
                    ⚡Studied subjects like DS and Algo, C and C++ programming,
                    DBMS, Computer Networks, Linux, etc.
                  </li>
                  <li>
                    ⚡Published 2 Research Papers in International Journals and
                    IEEE Conferences.
                  </li>
                </ul>
              </div>
