    ...
    <a href='https://blog.openreplay.com/i18n-in-next-14/' target='_blank' className='px-2 py-4 w-full flex flex-col md:flex-row lg:flex-row rounded-md gap-5 items-center  justify-center'>
        ...
        <div className="flex flex-col text-left space-y-5">
            <p className="text-blue text-lg font-semibold">Frontend</p>
                ...
                <p className="text-gray-300" id="line-clamp-3">In the rapidly evolving digital landscape, creating websites that cater to a global audience is not just an option but a necessity. Internationalization, or i18n, plays a pivotal role in web development, ensuring that your content reaches a global audience in different languages and regions seamlessly. This article will show you how to work with i18n in Next.js</p>
            </div>
    </a>
  )
}
